...
//?GL_MAP1 -> curva de Bezier
//?GL_MAP2 -> superfície de Bezier
...
void drawScene(void)
{
   ...
   glMap2f(GL_MAP2_VERTEX_3, 0, 1, 3, 4, 0, 1, 12, 6, controlPoints[0][0]); //*valores pros parametros da função glMap2f
