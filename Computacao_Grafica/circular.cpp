...
{  
   ...
   glEnable(GL_DEPTH_TEST); // Enable depth testing. Respeiro de profundidade //? buffer para controlar a sobreposição de objetos.
   glColor3f(1.0, 0.0, 0.0);
   drawDisc(20.0, 75.0, 75.0, 0.0);
   glColor3f(1.0, 1.0, 1.0);
   drawDisc(10.0, 75.0, 75.0, 0.5); // Compare this z-value with that of the red disc.
   glDisable(GL_DEPTH_TEST); // Disable depth testing. //? ele faz o calculo por pixel.
